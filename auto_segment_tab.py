...
class AutoSegmentationTab(QtWidgets.QWidget):
    ...
    def __init__(self, dicom_dir: str) -> None:
        ...
        :rtype: None
        """
        # self._dicom_dir = dicom_dir = QFileDialog.getExistingDirectory(self, "Select DICOM CT Series")
        # if not dicom_dir:
        #     return

        self.style_sheet: StyleSheetReader = StyleSheetReader()  # Making Member for Style Sheet
